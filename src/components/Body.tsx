            ...
            <Box px={4} pb={4} position="relative">
                <Box w={{ base: '100%', sm: '100%', md: '80%', lg: '70%' }} alignSelf="center" mt={-8} marginX="auto">
                    <Text
                        ...
                        textAlign="left" fontSize="28" lineHeight={1} fontFamily="Outfit">Cleaning services for all your needs
                    </Text>
                </Box>

                <Box alignSelf="center" pt={4} position="relative" marginX="auto" w={{ base: '100%', sm: '100%', md: '80%', lg: '70%' }}>
                    <Text fontFamily="Outfit" textAlign="left" fontSize="14" color="gray.700">The no-stress way to book the cleaning service you need in minutes. Eliminates back and forth emails. Book straight into our team`s schedule even on SUNDAY! </Text>
                </Box>
                            ...
                            < Box position="absolute" left={{ base: '40%', sm: '44%', lg: '40%' }} zIndex="2" top={'10'} >
                                <Flex opacity=".7" bgGradient='linear(to-tr, red.300, #e5236c)'
                                    ...
                                    <UnorderedList lineHeight={1} fontSize={14} ml={8} color='white'>
                                        ...
                                        <ListItem><Text fontFamily="Outfit" mb={2} fontWeight="bold" color="white">Get a Quote in less than 2 minutes</Text></ListItem>
